...
const coreEs = {
  ...
  home: {
    ...
    guardTipLabel: 'Tip de Guardia',
    quickGoteoKicker: '1 toque',
    quickGoteoTitle: 'Calculadora rápida de Goteo',
    quickGoteoA11y: 'Abrir calculadora rápida de goteo',
  },
  nav: {
    inicio: 'Inicio',
    calculos: 'Cálculos',
  ...
  drawer: {
    ...
    cursos: 'Cursos',
  congresos: 'Congresos',
  cursosInstitucion: 'Cursos (institución)',
  congresosInstitucion: 'Congresos (institución)',
  reuniones: 'Salas de reunión',
  meetingRecordings: 'Mis grabaciones',
  patologias: 'Patologías',
    ...
    supervisorFeeds: 'Publicar cursos',
    adminPayouts: 'Liquidaciones',
    feedInscriptions: 'Inscriptos',
    docenteApply: 'Ser docente',
    docenteApplications: 'Docentes',
