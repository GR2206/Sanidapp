...
const basePtBR = {
  ...
  home: {
    ...
    guardTipLabel: 'Dica de plantão',
    quickGoteoKicker: '1 toque',
    quickGoteoTitle: 'Calculadora rápida de gotejo',
    quickGoteoA11y: 'Abrir a calculadora rápida de gotejo',
  },
  nav: {
    inicio: 'Início',
    calculos: 'Cálculos',
  ...
  drawer: {
    ...
    cursosInstitucion: 'Cursos (instituição)',
    congresosInstitucion: 'Congressos (instituição)',
    reuniones: 'Salas de reunião',
    meetingRecordings: 'Minhas gravações',
    patologias: 'Patologias',
    patologiasEmphasis: 'PATOLOGIAS',
    contacto: 'Contato',
    conocenos: 'Conheça a Sanidapp',
    foro: 'Fórum',
    qrPrint: 'Impressão de QR',
    supervisorFeeds: 'Publicar cursos',
    adminPayouts: 'Liquidações',
    feedInscriptions: 'Inscritos',
